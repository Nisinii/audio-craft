        ...
        <div className="aboutus">
            ...
            <div className="display-section">
                <div className="heading_container">
                    <h2>ABOUT US</h2>
                    <p>Welcome to AudioCraft! We are passionate storytellers and innovators dedicated to revolutionizing the way narratives are experienced through audio.</p>
                    <p>AudioCraft was born out of a shared love for storytelling and technology. Frustrated by the limitations of traditional storytelling mediums, we set out to create a platform that harnesses the power of audio to bring stories to life in ways never before imagined. </p>
